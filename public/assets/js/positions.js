                ...
                $.get(`http://localhost:3000/api/department/allDepartments/${offset}`, (res) => {
                    ...
                    positions.forEach(position => {
                        ...
                        <tr>
                            ...
                            <td>${position.name}</td>
                            <td>
                                <a class="btn btn-outline-danger btn-sm" href="/positions/delete/${position.id}"><i class="bi bi-x-circle"></i></a>
                                <a class="btn btn-outline-secondary btn-sm" href="/positions/update/${position.id}"><i class="bi bi-pencil-square"></i></a>
                            </td>
                        </tr>
                        `
                    });
